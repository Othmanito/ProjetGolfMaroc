<div class="collapse navbar-collapse navbar-ex1-collapse">
  <ul class="nav navbar-nav side-nav">
    ...
    <li><a href="{{ Route('vendeur.addVente',[ 'p_id_mag' =>getChamp('transactions', 'id_transaction', $data->first()->id_transaction , 'id_magasin') ]) }}"><i class="fa fa-fw fa-plus"></i>  Ajouter une vente </a></li>

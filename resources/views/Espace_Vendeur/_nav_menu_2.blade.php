<div class="collapse navbar-collapse navbar-ex1-collapse">
  <ul class="nav navbar-nav side-nav">
    ...
    <li><a href="{{ Route('vendeur.addVente',[ 'p_id_mag' =>2]) }}" > <i class="fa fa-fw fa-plus"></i> Ajouter une vente </a></li>
    ...
    <li><a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="glyphicon glyphicon-shopping-cart"></i> Gestion des Ventes <i class="fa fa-fw fa-caret-down"></i></a>
      <ul id="demo" class="collapse">
        <li><a href="{{Route('vendeur.lister',['param' => 'transact','p_id_user'=>3 ]) }}">Ventes établies <span class="badge">{{ App\Models\Transaction::where(['id_typeTrans'=> 3,'id_user'=> 3 ])->count() }} </span></a></li>

           ...
           <tbody>
             ...
             <tr class="odd gradeA">
               ...
               <td>
                 ...
                 <a onclick="return confirm('Êtes-vous sure de vouloir effacer cette transaction: {{ $item->id_transaction }} ?')" href="#" title="supprimer"><i class="glyphicon glyphicon-trash"></i></a>
               </td>
             </tr>
             @endforeach
             @endif
    ...
    <!-- row -->
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <a href="{{ Route('vendeur.addFormVente',[ 'p_id_user' => $data->first()->id_user ]) }}" type="button" class="btn btn-outline btn-default">  Ajouter une vente </a>
        </div>
      </div>
      <!-- row -->

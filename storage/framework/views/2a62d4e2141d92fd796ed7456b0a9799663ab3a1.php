  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="table-responsive">
           ...
           <thead>
             <tr><th width="2%"> # </th><th>Article</th><th>Quantité</th><th width="10%">Autres</th></tr>
           </thead>
           ...
           <tbody>
             ...
             <tr class="odd gradeA">
               ...
               <td>
                 ...
                 <a onclick="return confirm('Êtes-vous sure de vouloir effacer cette transaction: <?php echo e($item->id_transaction); ?> ?')" href="#" title="supprimer"><i class="glyphicon glyphicon-trash"></i></a>
               </td>
             </tr>
    ...
    <!-- row -->
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <a href="<?php echo e(Route('vendeur.addFormVente',[ 'p_id_user' => $data->first()->id_user ])); ?>" type="button" class="btn btn-outline btn-default">  Ajouter une vente </a>
        </div>
      </div>
      <!-- row -->
